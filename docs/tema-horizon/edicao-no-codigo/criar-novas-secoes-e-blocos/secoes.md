...
Uma seção é uma parte horizontal do layout que pode ser habilitada ou escondida, ter ou não blocos e  configurações que alteram o comportamento dentro do tema. Uma seção pode ser configurada para ser posicionada em qualquer outra posição do layout, dando uma infinidade de opções para o usuário.
