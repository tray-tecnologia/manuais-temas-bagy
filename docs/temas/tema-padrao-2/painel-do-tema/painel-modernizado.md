...
![](/tema-padrao-2/painel-tema-painel-modernizado.png)
...
Cada uma das seções desse painel estarão disponíveis dentro do tema de edição do tema. Para isso basta acessar _**Configurações > Minha loja > Editar layout**_ e clicar em _**Editar Tema**_.

A opção de **Editar tema** será exibida nos temas que estejam atualmente publicados e também nos temas instalados e não publicados, como mostra as imagens a seguir:

_**Em um tema publicado:**_

![](/tema-padrao-2/painel-tema-painel-modernizado-2.png)

_**Em um tema instalado e não publicado:**_

![](/tema-padrao-2/painel-tema-painel-modernizado-3.png)

O painel constituiu de quatro áreas principais:

* **Cabeçalho**: Inclui links úteis para essa documentação e suporte, além do botão para publicar o tema, editar HTML e registro de alterações. **Atenção:** Esses três últimos itens só serão exibidos se o tema não estiver publicado.
* **Abas**: As abas separam as seções do painel do tema para que tudo fique mais organizado e fácil de ser encontrado. Uma aba ativa fica com a cor do título e a borda inferior azul sinalizadas com a cor azul escuro.
...
![](/tema-padrao-2/painel-tema-painel-modernizado-4.png)
