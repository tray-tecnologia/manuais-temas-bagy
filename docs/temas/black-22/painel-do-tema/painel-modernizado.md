...
Cada uma das seções desse painel estarão disponíveis dentro do tema de edição do tema. Para isso basta acessar _**Minha Loja > Design da Loja**_ ou em _**Minha Loja > Aparência da Loja**_ e clicar em _**Editar Tema**_.
