...
::: info Atenção:
Alguns dos atributos listados não podem ser usados em todas as tags HTML listadas acima. É dever do desenvolvedor saber quais atributos podem ser usados com quais tags.
:::
