...
::: danger **Atenção!**
O código fonte do editor antes da compilação **não está** disponível aos clientes e parceiros, sendo de uso exclusivo Tray!
:::

### Localização dos arquivos

Os arquivos do editor do Tema Horizon ficam dentro da estrutura de arquivos do tema em diferentes pastas. As pastas `css/editor`  e `js/editor` guardam os arquivos `.css` e `.js` compilados pelo time.
