...
Esse tema inclui um painel super moderno e intuitivo. Essa nova versão conta com um design mais clean e minimalista.
...
É possível **exibir** ou **ocultar** um bloco da seção. Para isso basta clicar no ícone de olho.
...
O painel é constituído de três áreas principais:
