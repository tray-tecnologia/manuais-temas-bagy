 ...
 * @returns
 */
export const getTemaPadraoBagy3Sidebar = (basePath: string): DefaultTheme.SidebarItem[] => {
      ...
      items: [
...

        {
          ...
          items: [
            ...
            {
              text: 'Produtos Visualizados Recentemente',
              link: `produtos-visualizados-recentemente`,
            },
          ],
        },
      ],
